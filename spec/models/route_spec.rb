...
describe Route do
  ...
  describe "when counting routes without operators " do
    ...
    it 'should return current routes without route operators' do
      Route.count_current_without_operators.should == 3
    end
  ...
  describe 'when finding codes without operators' do
    ...
    it 'should return codes (with counts) that are attached to routes but have no operators' do
      Route.find_current_codes_without_operators.should == [['TUBE', '2'], ['LONDON_BUS', '1']]
    end
  ...
  describe 'when counting codes without operators' do
    ...
    it 'should return the number of operator codes in use for which there are no operators' do
      Route.count_current_codes_without_operators.should == 2
    end
  ...
  describe 'if a bus route across regions' do
    ...
    before do
      ...
      @route.stub!(:region).and_return(mock_model(Region, :name => 'Great Britain'))
  ...
  describe 'if in London, and a bus route' do
    ...
    describe 'when asked if the PTE is responsible' do
      ...
      it 'should return true' do
        @route.pte_responsible?.should == true
      end
