...
Rails::Initializer.run do |config|
  ...
  config.gem "friendly_id", :version => '3.1.6'
  config.gem 'paper_trail', :version => '1.5.1'
  config.gem 'authlogic', :version => '2.1.6'
  config.gem 'ruby-msg', :version => '1.4.0'
...
ExceptionNotification::Notifier.sender_address = %("FixMyTransport" <#{MySociety::Config.get("CONTACT_EMAIL", "")}>)
