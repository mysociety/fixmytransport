# This module extends the slug model provided by the friendly_id gem to add some specific functionality
...
module FriendlyIdDataGenerationsExtensions
...
Slug.send(:include, FriendlyIdDataGenerationsExtensions)
Slug.setup_data_generations