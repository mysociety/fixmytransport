class LocationSweeper < ActionController::Caching::Sweeper
  ...
  def expire_stop_fragments(stop)
    ...
    expire_fragment("#{stop_cache}.action_suffix=map_variant")
  end
  ...
  def expire_stop_area_fragments(stop_area)
    ...
    expire_fragment("#{stop_area_cache}.action_suffix=map_variant")
  end
  ...
  def expire_route_fragments(route)
    ...
    expire_fragment("#{route_cache}.action_suffix=map_variant")
  end
