class Admin::HomeController < Admin::AdminController
  ...
  def index
    @routes_without_operators = Route.find_current_without_operators(:limit => 10)
    @routes_without_operators_total = Route.count_current_without_operators
    @operator_codes_without_operators = Route.find_current_codes_without_operators(:limit => 20)
    @operator_codes_without_operators_total = Route.count_current_codes_without_operators
